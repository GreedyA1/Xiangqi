...
import xiangqi.studentVmargvelashvili.versions.alphaxiangqi.AlphaXiangqiGame;
import xiangqi.studentVmargvelashvili.versions.betaxiangqi.BetaXiangqiGame;
import xiangqi.studentVmargvelashvili.versions.deltaxiangqi.DeltaXiangqiGame;
import xiangqi.studentVmargvelashvili.versions.gammaxiangqi.GammaXiangqiGame;
...
public class XiangqiGameFactory
{
	...
	public static XiangqiGame makeXiangqiGame(XiangqiGameVersion version)
	{
		...
		//return version == XiangqiGameVersion.BETA_XQ ? new AlphaXiangqiGame() : null;
	}
